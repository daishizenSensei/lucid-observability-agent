  ...
  server.resource('conventions', `${prefix}://conventions`,
    ...
    async () => ({
      contents: [{
        ...
        text: JSON.stringify(getConventionsData(config), null, 2),
      }],
    }),
  );
  ...
  server.resource('services', `${prefix}://services`,
    ...
    async () => ({
      contents: [{
        uri: `${prefix}://services`,
        mimeType: 'application/json',
        text: JSON.stringify(getServicesData(config), null, 2),
      }],
    }),
  );
  ...
  server.resource('sampling', `${prefix}://sampling`,
    ...
    async () => ({
      contents: [{
        uri: `${prefix}://sampling`,
        mimeType: 'application/json',
        text: JSON.stringify(getSamplingData(config), null, 2),
      }],
    }),
  );
}
